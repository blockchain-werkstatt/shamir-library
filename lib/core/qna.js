...
var split_qna = function split_qna(secret, no_of_combination, questions, answers, publicAddress, type) {
    var splits = '';
    if (type === 'hex') {
        splits = (0, _utilities.split)(secret, questions.length, no_of_combination, _utilities.prime512);
    } else {
        splits = (0, _utilities.split)(secret, questions.length, no_of_combination, _utilities.prime3217);
    }
...
var combine_qna = function combine_qna(originalquestions, publicshare, questions, answers, publicAddress, type) {
    ...
    var secret = '';
    if (type === 'hex') {
        secret = (0, _utilities.combine)(originalSpits, _utilities.prime512);
    } else {
        secret = (0, _utilities.combine)(originalSpits, _utilities.prime3217);
    }
    return secret.toHex();
};
